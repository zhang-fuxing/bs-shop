    ...
    <el-form
        ...
        <el-form-item label="预览图片" prop="previewList">
            <el-upload
                ...
                :headers="previewListUploadHeaders"
                :data="previewListUploadData"
        ...
        <el-form-item label="详情图片" prop="detailsList">
            <el-upload
                ...
                :file-list="detailsListFileList" :headers="detailsListUploadHeaders"
                :data="detailsListUploadData" list-type="picture-card" show-file-list :limit="3">
                <template
                    #default>
                    <el-icon>
                        <Plus/>
        ...
        <div class="productSubmit">
            <el-row>
                ...
                <el-col :span="2" :offset="1" class="grid-cell">
                    <div class="static-content-item">
                        <el-button type="primary" color="red">重置</el-button>
                    </div>
                </el-col>
            </el-row>
            <hr>
...
import {uploadPreview, uploadDetails, renderJson, categoryLevel1, lv2} from "@/api";
